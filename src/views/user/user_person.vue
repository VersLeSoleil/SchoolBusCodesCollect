<template>
    <div class="container">
        ...
        <header class="header">
            ...
            <div class="user-info"  v-if="userStore.userInfo && userStore.userInfo.name && userStore.userInfo.avatar">
...
.header {
    ...
    backdrop-filter: blur(8px); /* 半透明背景时建议加上模糊效果 */
}
...
/* 左侧菜单 */
.sidebar {
    width: 250px;           /* 或者 min-width: 250px; */
...
.el-menu-item {
    ...
    /* 通过 transform 偏移文字向左 */
    transform: translateX(-10px); /* 偏移 10px，可以调整 */
}
...
.el-menu-vertical-demo {
    width: 100%;
    font-size: 16px;
    background: transparent; /* 用自身的背景，去掉默认 */
...
.el-menu-item:hover {
    ...
    color: #409eff;
    background-color: #f1faff; /* 悬停时给一点浅色背景 */
}
